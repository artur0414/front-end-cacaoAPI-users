...
export default function ThemeToggle() {
  ...
  return (
    <div className="absolute top-auto bottom-2 right-2 md:bottom-4 md:right-4 lg:bottom-8 flex justify-center items-center px-8 py-4 rounded-full bg-white dark:bg-custom-black-2 gap-4 shadow-[0px_4px_6px_rgba(0,0,0,0.1)] z-40">
      {" "}
